...
import com.berthms.app.HasLogger;
import com.berthms.app.security.CurrentUser;
import com.berthms.backend.entity.AbstractEntity;
import com.berthms.backend.service.UserService.UserCrudService;
import com.berthms.backend.service.UserService.UserFriendlyDataException;
import com.berthms.ui.utils.messages.CrudErrorMessage;
...
public class UserCrudEntityPresenter<E extends AbstractEntity>	implements HasLogger {

	private final UserCrudService<E> crudService;

	private final CurrentUser currentUser;

	private final HasNotifications view;

	public UserCrudEntityPresenter(UserCrudService<E> crudService, CurrentUser currentUser, HasNotifications view) {
