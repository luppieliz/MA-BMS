package com.berthms.ui.crud.User;
...
import com.berthms.backend.service.UserService.UserFilterableCrudService;
...
public abstract class UserAbstractAppCrudView<E extends AbstractEntity> extends Crud<E>
    ...
    private final UserCrudEntityPresenter<E> entityPresenter;

    protected abstract String getBasePage();

    protected abstract void setupGrid(Grid<E> grid);

    public UserAbstractAppCrudView(Class<E> beanType, UserFilterableCrudService<E> service,
        ...
        UserCrudEntityDataProvider<E> dataProvider = new UserCrudEntityDataProvider<>(service);
        grid.setDataProvider(dataProvider);
        setupGrid(grid);
        Crud.addEditColumn(grid);

        entityPresenter = new UserCrudEntityPresenter<>(service, currentUser, this);
    ...
    private void setupCrudEventListeners(UserCrudEntityPresenter<E> entityPresenter) {
