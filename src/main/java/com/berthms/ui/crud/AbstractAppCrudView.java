...
public abstract class AbstractAppCrudView<E extends AbstractEntity> extends Crud<E>
    ...
    public AbstractAppCrudView(Class<E> beanType, FilterableCrudService<E> service,
